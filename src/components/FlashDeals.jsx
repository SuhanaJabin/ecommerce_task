...
const FlashDeals = () => {
  ...
  return (
    <div className="flash-deals-container w-full max-w-[1200px] mx-auto bg-gradient-to-r from-[#0A141B] to-[#9CF6F6] p-6 sm:p-8 rounded-lg shadow-2xl my-8">
      ...
      {selectedProducts.map((product, index) => {
        ...
        return (
          <Carousel.Item key={index}>
            <div className="flex flex-col sm:flex-row items-center mx-auto sm:items-start justify-between p-4 sm:p-6 bg-[#B5D6D6] rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 w-full sm:w-[600px]"> {/* Fixed width added here */}
              ...
              <div className="mt-6 sm:mt-4 text-center sm:text-right w-1/2 align-items sm:w-auto justify-center">
